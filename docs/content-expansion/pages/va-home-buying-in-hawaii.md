# VA Home Buying in Hawaii | Hawaii Military Realty

## Page identity

- Route: `category/va-home-buying-in-hawaii.html`
- Key: `va-home-buying-in-hawaii`
- Collection: `evergreenPages`
- Source of work product: `src/content-seo.js`

## Search intent and audience

This page is for military and veteran buyers who understand the VA concept and now need to apply it to Oahu property types, neighborhoods, and timing.
