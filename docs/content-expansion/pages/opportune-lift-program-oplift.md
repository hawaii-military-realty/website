# Opportune Lift Program (OPLIFT) | Hawaii Military Realty

## Page identity

- Route: `military-real-estate-hawaii/oplift.html`
- Key: `opportune-lift-program-oplift`
- Collection: `evergreenPages`
- Source of work product: `src/content-seo.js`

## Search intent and audience

This page is for service members and families researching military support resources while preparing for an Oahu transition.
