# Kapolei Real Estate Listings | Hawaii Military Realty

## Page identity

- Route: `kapolei-real-estate-2/kapolei-real-estate.html`
- Key: `kapolei-real-estate-listings-and-information`
- Collection: `evergreenPages`
- Source of work product: `src/content-seo.js`

## Search intent and audience

This page is for buyers and relocating households looking at Kapolei as a serious option in the West Oahu growth corridor.
