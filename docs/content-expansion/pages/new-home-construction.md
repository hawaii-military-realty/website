# New Home Construction | Hawaii Military Realty

## Page identity

- Route: `new-home-constructionewa-beach.html`
- Key: `new-home-construction`
- Collection: `evergreenPages`
- Source of work product: `src/content-seo.js`

## Search intent and audience

This page is for buyers who are drawn to newer homes in Ewa Beach, Kapolei, and West Oahu, especially remote buyers and military households trying to line up housing with orders.
