# Our Cooperating Broker Commissions | Hawaii Military Realty

## Page identity

- Route: `our-cooperating-broker-commissions.html`
- Key: `our-cooperating-broker-commissions`
- Collection: `evergreenPages`
- Source of work product: `src/content-seo.js`

## Search intent and audience

This page is for buyers, sellers, cooperating brokers, and referral partners who need commission language handled plainly and professionally.
